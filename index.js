...
const gameRunnerSound = new Audio("./musics/game_runnner.mp3");
const gamePlaySound = new Audio("./musics/game_play.mp3");
const gameOverSound = new Audio("./musics/game_over.wav");
const gameTurnSound = new Audio("./musics/game-turn.mp3");
const gameFoodEatingSound = new Audio("./musics/food_eating_sound.wav");
let snakeSpeed = 4;
